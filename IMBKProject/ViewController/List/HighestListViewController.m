...
#import "HighestListViewController.h"
#import "ListCell.h"
#import "DetailViewController.h"

@interface HighestListViewController ()
@property (weak, nonatomic) IBOutlet UITableView *tblHigh;

@end

@implementation HighestListViewController
@synthesize myKey;
...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.navigationItem.title = @"IMKB Yükselenler";
...
{
    [self performSegueWithIdentifier:@"DetailHigh" sender:tableView];
}

- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    NSIndexPath *myIndexPath = [self.tblHigh indexPathForSelectedRow];
    
    if ([segue.identifier isEqualToString:@"DetailHigh"]) {
